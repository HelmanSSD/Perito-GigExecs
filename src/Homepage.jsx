...
function Homepage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F5F5F5] via-[#F5F5F5] to-[#FFFFFF]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden lg:flex items-center space-x-12">
              <a href="#what-is" className="text-[#1F2937] hover:text-[#0284C7] transition-colors">What is GigExecs</a>
            ...
            <div className="flex items-center">
              <Button size="lg" variant="outline" className="border-[#012E46] text-[#012E46] hover:bg-[#F5F5F5] rounded-r-none border-r-0">
                Sign in
              </Button>
              <Button size="lg" className="bg-[#012E46] hover:bg-[#0284C7] text-white rounded-l-none">
                Join
              </Button>
            </div>
          ...
          <div className={`lg:hidden transition-all duration-300 ease-in-out overflow-hidden ${
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-[#F5F5F5]">
              <a href="#what-is" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 text-[#1F2937] hover:text-[#0284C7] transition-colors">What is GigExecs</a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center hover:shadow-lg transition-shadow duration-300 border-0 shadow-md">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-[#FACC15]">Transparent and Easy Pricing</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow duration-300 border-0 shadow-md">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-[#FACC15]">Give and Receive Feedback and Ratings</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-[#9CA3AF]">
            ...
            <Card className="text-center hover:shadow-lg transition-shadow duration-300 border-0 shadow-md">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-[#FACC15]">Direct Communication</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-[#9CA3AF]">
            ...
            <Card className="text-center hover:shadow-lg transition-shadow duration-300 border-0 shadow-md">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-[#FACC15]">Verified Profiles</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-[#9CA3AF]">
      ...
      {/* Newsletter Section */}
      <section id="newsletter" className="py-20 bg-[#012E46]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <Input
              ...
              required
            />
            <Button size="lg" type="submit" className="bg-white text-[#012E46] hover:bg-[#F5F5F5]">
