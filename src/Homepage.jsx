          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
                ...
                <CardTitle className="text-xl">Transparent and Easy Pricing</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
                ...
                <CardTitle className="text-xl">Give and Receive Feedback and Ratings</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-[#9CA3AF]">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <Input
              ...
              required
            />
            <Button type="submit" className="bg-white text-[#012E46] hover:bg-[#F5F5F5]">
